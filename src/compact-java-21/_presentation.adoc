...
// Raketen Start Bild
// die Zombies wollen es selber Warten
// Dummerweise sind sie nicht besonders visiert und lernen erst Java
// Es reicht Strings zu interpolieren, wir bauen es als eine kleine Main Methode
