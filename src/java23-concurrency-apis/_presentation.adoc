...
image::images/AamCjmYS.jpg[background,size=cover]
...
[.column.is-one-third]
--
[mermaid,format=svg,target=images/generated/thread_forking,height=400px]
----
---
title: Birth and Death of Threads
---
...
[.column]
--
[mermaid,format=svg,target=images/generated/thread_states,height=400px]
----
---
...
image::images/dhhhSRjf.jpg[background,size=cover]
...
[mermaid,format=svg,target=images/generated/thread_normal]
----
stateDiagram-v2
...
image::images/SVT84DAs.jpg[background,size=cover]
...
image::images/wpEBCJQU.jpg[background,size=cover]
...
[mermaid,format=svg,target=images/generated/structured_concurrency_concept,height=400px]
----
gantt
    dateFormat HH:mm
    axisFormat %H:%M
